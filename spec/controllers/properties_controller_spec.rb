  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved property as @property" do
        ...
        post :create, {:property => { "number_of_rooms" => "invalid value" }}, valid_session
        assigns(:property).should be_a_new(Property)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested property" do
        ...
        Property.any_instance.should_receive(:update_attributes).with({ "number_of_rooms" => "1" })
        put :update, {:id => property.to_param, :property => { "number_of_rooms" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the property as @property" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Property.any_instance.stub(:save).and_return(false)
        put :update, {:id => property.to_param, :property => { "number_of_rooms" => "invalid value" }}, valid_session
        assigns(:property).should eq(property)
      end
